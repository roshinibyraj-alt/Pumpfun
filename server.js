  ...
  for (const [key, cfg] of Object.entries(config.ENGINES)) {
    ...
    engines[key] = {
      ...
      config: {
        ...
        TAKER_SLIPPAGE_MIN: config.TAKER_SLIPPAGE_MIN,
        TAKER_SLIPPAGE_MAX: config.TAKER_SLIPPAGE_MAX,
        STOP_LOSS_PRICE: config.LEADER.STOP_LOSS_PRICE,
        ENTRY_CUTOFF_SEC: config.LEADER.ENTRY_CUTOFF_SEC,
      },
      liveWindow: live,
      totalFees: fees,
      totalRebates: rebates,
